! function () {
    ...
    function S(t) {
        var e = new D(t),
            n = new O(e);
        e.harvestScriptsInDocument(), new j(e, {
            blocking: !0,
            docWriteSimulator: n,
            callback: function () { }
        }).run()
    ...
    function x(t) {
        var e = new N(t);
        M.simulateStateBeforeDeferScriptsActivation(), e.harvestDeferScriptsInDocument(), new j(e, {
            blocking: !1,
            callback: function () {
                M.simulateStateAfterDeferScriptsActivation(), B && B()
            }
        }).run()
    }
        ...
        _ = Object.setPrototypeOf || {
            ...
            instanceof Array && function (t, e) {
                ...
                return t.prototype.insertPreloadHints = function () {
                    ...
                    return c ? (a.insertBefore(c, r), c) : (a.insertBefore(c, r), c)
                }, t
            }(), W = "data-cf-settings", R = "|", T = "data-cf-modified-", B = void 0;
    ! function () {
        var t = document.currentScript;
        var n = y(t);
        n ? (o(t), b(n), M.updateInlineHandlers(), n.bailout ? S(n.nonce) : (g(), w(n.nonce))) : w(n.nonce);
    }();
}();